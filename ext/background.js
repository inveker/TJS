...
// CONCATENATED MODULE: ./background/modify/body.js
/* harmony default export */ function body(details, callback) {
...
var RegExpValidationState = function RegExpValidationState(parser) {
  ...
  this.unicodeProperties = acorn_data[parser.options.ecmaVersion >= 12 ? 12 : parser.options.ecmaVersion];
  this.source = "";
  this.flags = "";
  this.start = 0;
  this.switchU = false;
...
// CONCATENATED MODULE: ./background/modify/script.js


/* harmony default export */ function modify_script(string) {
    let str_arr = string.split('');
    let ast = parse(string, {ecmaVersion: 2020})
...
// CONCATENATED MODULE: ./background/modify/request.js




var request_store = getGlobalStore();

/* harmony default export */ function request(details) {
    let url, mod_fn;
    //Inline scripts
    ...
    //Src scripts
        ...
        mod_fn = function (str) {
            return modify_script(str);
        };
    }
    //Inject
    if(url) {
        let host = new URL(url).hostname;
        if (request_store.get('urls').indexOf(host) != -1)
            body(details, mod_fn);
    }
}


// CONCATENATED MODULE: ./background/app.js



//Background window obj
const b_window = browser.extension.getBackgroundPage();
const app_console = b_window.console;


//Enable store
var app_store = createStore();
app_store.set('urls', ['aaa']);
